...
根据欧共体“远距离教育与训练项目”(DGXⅢ)的有关文件，支架式教学被定义为：“支架式教学应当为学习者建构对知知识的理解提供一种概念框架(conceptualframework)。这种框架中的概念是为发展学习者对问题的进一步理解所需要的，为此，事先要把复杂的学习任务加以分解，以便于把学习者的理解逐步引向深入。”         
...
#### 基于认知主义与建构主义教育软件示例
![翻转课堂1](/assets/理论/翻转课堂1.png)
![翻转课堂2](/assets/理论/翻转课堂2.png)
![翻转课堂3](/assets/理论/翻转课堂3.png)
翻转学堂app中：老师是学生身边的“教练”，不是在讲台上的“圣人”。混合了直接讲解与建构主义学习。  
![翻转课堂4](/assets/理论/翻转课堂4.png)
...
#### 基于行为主义理论的教育软件示例
![行为主义1](/assets/理论/扇贝单词1.png)
![行为主义2](/assets/理论/扇贝单词2.png)
扇贝单词是一款基于行为主义理论的识记单词的学习软件。同时具有碎片化学习、扇贝打卡、拓展包订制等特色功能。  
![行为主义1](/assets/理论/扇贝单词3.png)
扇贝单词基于行为主义理论，利用“刺激——反应”原理，根据学习者每天记单词的进度规划单词学习量，不断进行单词识别的训练、系统会将识别错误的单词记入未完成单词量反复强化对单词的记忆与理解。最终达到识记的效果。     
### 联通主义
